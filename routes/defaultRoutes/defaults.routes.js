...
const { index, about, our_products, farming_practice, shop, news, news_details, contact, profile, place_order, add_to_cart, getCart } = require("../../controllers/defaultControllers/default.controller");
